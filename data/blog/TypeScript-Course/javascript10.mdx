...
ES6 introduced native support for modules in JavaScript, using `export` and `import`. Here’s how to create and use them:

### Example: Defining and Exporting a Module

Let’s create a simple `math.js` module with some basic functions.
